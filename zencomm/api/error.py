...
ERROR_MAP = {
    ...
    ErrCodes.USER_SESSION_EXPIRED: ErrMsg.ERRMSG_USER_SESSION_EXPIRED,
    ErrCodes.INVALID_REQUEST_URL: ErrMsg.ERRMSG_INVALID_REQUEST_URL,
    ErrCodes.USER_OR_PASSWD_INCORRECT: ErrMsg.ERRMSG_USER_OR_PASSWD_INCORRECT,
}
